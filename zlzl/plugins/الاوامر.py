...
Malath = f"**🖥┊لـوحـة أوامـر 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 الشفـافـه **\n**🧑🏻‍💻┊المُستخـدِم ↶** {mention} \n\n•❶•** أوامـر الـبحـث والـتحميـل **\n•❷•** أوامــر الـبـوت **\n•❸•** أوامــر الـوقـتـي **\n•❹•** أوامــر المجمـوعـة¹ **\n•❺•** أوامــر المجمـوعـة² **\n•❻•** أوامــر الـحسـاب **\n•❼•** أوامــر الميـديـا والـصيــغ **\n•❽•** أوامــر الـفــارات **\n•❾•** أوامــر الخـدمــات العـامــه **\n•❿•** أوامــر الألعــاب **\n•⓫•** أوامــر التسـليــة**\n•⓬•** أوامــر التحشيـش**\n•⓭•** أوامــر الستـوريات**\n•⓮•** أوامــر الآفتــارات**\n•⓯•** أوامــر الصيــد والتشيكــر **\n•⓰•** أوامــر النشــر التلقــائي **\n•⓱•** أوامــر تجميــع النقــاط **\n•⓲•** اوامــر الاشتـراك الإجبـاري **\n•⓳•** اوامــر الإضـافة والتفليــش**\n•⓴•** اوامــر النشـر العـام (الـسوبـرات)**\n\n**•❐• لعـرض الاوامـر مع الوصـف ارسـل** `.اوامري`\n**•❐• لعـرض شـروحـات الاوامـر ارسـل** `.مساعده` "
...
@check_owner
async def zed_handler(event):
    zelzal = "⤶ عُـذرًا عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحـة لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الأوامـر هنـا 👇\n\n⤶ أرســل (.اوامري)"
