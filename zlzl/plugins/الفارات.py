...
ZelzalVP_cmd = (
    "𓆩 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𝗩𝗮𝗿𝘀 **🝢 اوامـر الفـارات** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    ...
    "\n𓆩 [𝗧𝗘𝗣𝗧𝗛𝗢𝗡𝗗 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/Tepthone1) 𓆪"
)
...
ZelzalTZ_cmd = (
    ...
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    "**✧ قائمـة اوامر تغييـر المنطقـة الزمنيـة لـ ضبط الوقت علــى تيبثـون حسب توقيت دولتك 🌐:** \n\n"
    "⪼ `.وقت فلسطين` \n"
    "⪼ `.وقت اليمن` \n"
    "⪼ `.وقت العراق` \n"
    "⪼ `.وقت السعودية` \n"
